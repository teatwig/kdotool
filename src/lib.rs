...
pub fn run_script(
    ...
    let script_contents = generate_script(context, parser, &command)?;
    ...
    let script_id: i32;
    (script_id,) = scripting_proxy(kwin_conn).method_call(
...
pub fn create_connection() -> anyhow::Result<Connection> {
